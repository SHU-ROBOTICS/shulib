...
*struct, declared at [`include/shulib/localization/localizer.hpp:121`](../../include/shulib/localization/localizer.hpp#L121).*
...
*field, declared at [`include/shulib/localization/localizer.hpp:124`](../../include/shulib/localization/localizer.hpp#L124).*
...
*field, declared at [`include/shulib/localization/localizer.hpp:127`](../../include/shulib/localization/localizer.hpp#L127).*
...
*field, declared at [`include/shulib/localization/localizer.hpp:133`](../../include/shulib/localization/localizer.hpp#L133).*
...
*field, declared at [`include/shulib/localization/localizer.hpp:139`](../../include/shulib/localization/localizer.hpp#L139).*
...
*field, declared at [`include/shulib/localization/localizer.hpp:176`](../../include/shulib/localization/localizer.hpp#L176).*
...
```cpp
Localizer(hal::IClock& clock, hal::IImu& imu, IOdometry& odom, IFusionPolicy& fusion, std::span<ICorrector* const> correctors = {}, const LocalizerConfig& config = {})
```
...
*function, declared at [`include/shulib/localization/localizer.hpp:180`](../../include/shulib/localization/localizer.hpp#L180).*
...
*function, declared at [`include/shulib/localization/localizer.hpp:212`](../../include/shulib/localization/localizer.hpp#L212).*
...
*function, declared at [`include/shulib/localization/localizer.hpp:418`](../../include/shulib/localization/localizer.hpp#L418).*
...
*function, declared at [`include/shulib/localization/localizer.hpp:435`](../../include/shulib/localization/localizer.hpp#L435).*
...
*function, declared at [`include/shulib/localization/localizer.hpp:443`](../../include/shulib/localization/localizer.hpp#L443).*
...
*function, declared at [`include/shulib/localization/localizer.hpp:451`](../../include/shulib/localization/localizer.hpp#L451).*
...
Forwarding accessor for IOdometry::lastDeltaImplausible() — added at C1 (additive) so the motion loop can feed HealthMonitor's odomImplausible observable without holding the odometry itself. Raising stays POLICY: this only EXPOSES the flag; the Localizer still never raises faults (D3 at A3).

*function, declared at [`include/shulib/localization/localizer.hpp:456`](../../include/shulib/localization/localizer.hpp#L456).*
...
*function, declared at [`include/shulib/localization/localizer.hpp:465`](../../include/shulib/localization/localizer.hpp#L465).*
...
Teleport the POSITION (x, y); heading stays IMU-owned. Forwards to IOdometry::setPose so the predictor and the fused belief never diverge, and re-baselines twist + dt so the teleport injects no phantom velocity next tick.  E3: the learned heading bias is KEPT, deliberately. A teleport says where the robot IS, not which way the IMU is wrong; discarding a bias that took a second of tag sightings to learn, every time a routine re-seeds its position, would throw away the correction at exactly the moments a routine cares most. `p.heading()` is still ignored, as it always was.

*function, declared at [`include/shulib/localization/localizer.hpp:477`](../../include/shulib/localization/localizer.hpp#L477).*
...
*enum class, declared at [`include/shulib/localization/localizer.hpp:155`](../../include/shulib/localization/localizer.hpp#L155).*
...
*enumerator, declared at [`include/shulib/localization/localizer.hpp:159`](../../include/shulib/localization/localizer.hpp#L159).*
...
*enumerator, declared at [`include/shulib/localization/localizer.hpp:166`](../../include/shulib/localization/localizer.hpp#L166).*
...
*enumerator, declared at [`include/shulib/localization/localizer.hpp:171`](../../include/shulib/localization/localizer.hpp#L171).*
...
<details markdown="1">
<summary>The header’s own reasoning — 89 lines, click to expand</summary>
