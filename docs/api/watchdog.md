...
*class, declared at [`include/shulib/control/watchdog.hpp:29`](../../include/shulib/control/watchdog.hpp#L29).*
...
`timeout` is in SECONDS and must be > 0; a zero or negative deadline is a caller bug, not a request to fire immediately. `clock` is stored by reference, never copied — pass the same IClock the surrounding loop reads, so the deadline lives on one timeline (and in a test, on the fake clock the test advances). Does NOT begin counting: call start().

*function, declared at [`include/shulib/control/watchdog.hpp:35`](../../include/shulib/control/watchdog.hpp#L35).*
...
*function, declared at [`include/shulib/control/watchdog.hpp:40`](../../include/shulib/control/watchdog.hpp#L40).*
...
*function, declared at [`include/shulib/control/watchdog.hpp:46`](../../include/shulib/control/watchdog.hpp#L46).*
...
*function, declared at [`include/shulib/control/watchdog.hpp:52`](../../include/shulib/control/watchdog.hpp#L52).*
...
*function, declared at [`include/shulib/control/watchdog.hpp:58`](../../include/shulib/control/watchdog.hpp#L58).*
...
*function, declared at [`include/shulib/control/watchdog.hpp:62`](../../include/shulib/control/watchdog.hpp#L62).*
