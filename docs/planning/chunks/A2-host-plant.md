...
**Read first:** `docs/planning/build-order.md` (Phase A, and "The missing prerequisite"),
`docs/planning/chunks/A1-COMPLETED.md` (what A1 just built and its decision log), and the house style
...
Append to `docs/planning/chunks/A2-PROGRESS.md` **as work happens**, not at the end. The user watches
...
Then write **`docs/planning/chunks/A2-COMPLETED.md`** in the same shape as `A1-COMPLETED.md`: what was
