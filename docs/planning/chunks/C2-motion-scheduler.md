...
`docs/planning/chunks/C2-PROGRESS.md`, appended as work happens (`date +%H:%M:%S`). Vocabulary
...
All six, plus **`docs/planning/chunks/C2-COMPLETED.md`** at C1's depth (570 lines, 13 sections),
