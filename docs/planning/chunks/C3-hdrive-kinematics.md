...
`docs/planning/chunks/C3-PROGRESS.md`, appended as work happens (`date +%H:%M:%S`), vocabulary
...
All six, plus **`docs/planning/chunks/C3-COMPLETED.md`** at C1/C2 depth (570 and 605 lines), including
