...
| Register entries | `docs/planning/hardware-assumptions.md` *(modified)* | HA-54 (the traction derate — the underivable part of authority) + HA-55 (the stand-in geometry); register 53 → 55, reconciled both directions (grep-verified) |
