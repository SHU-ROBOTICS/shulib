...
### In
1. **The Hardware Assumptions Register** — `docs/planning/hardware-assumptions.md`
...
- [ ] `docs/planning/hardware-assumptions.md` exists, every current assumption entered as a falsifiable
...
Append to `docs/planning/chunks/A4-PROGRESS.md` as work happens (`date +%H:%M:%S`), same vocabulary:
...
All six, plus **`docs/planning/chunks/A4-COMPLETED.md`**. A4 is smaller than A2/A3, so match their
