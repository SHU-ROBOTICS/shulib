...
| Roadmap fix | `docs/planning/roadmap.md` *(modified)* | The A2 task added under M2 (the incompleteness bug closed, with evidence); "you are here" → A2 done / A3 next |
| Position | `docs/planning/build-order.md` *(modified)* | Current position updated; "There is no host sim" struck through with its honest residual |
