...
| **The assumptions register** | `docs/planning/hardware-assumptions.md` | any new invented constant gets an `HA-nn` entry |
...
`docs/planning/chunks/C1-PROGRESS.md`, appended as work happens (`date +%H:%M:%S`), vocabulary
...
All six, plus **`docs/planning/chunks/C1-COMPLETED.md`** at A2/A3 depth. Note in the Freeze Register
