...
`docs/internal/chunks/C5-PROGRESS.md`, appended as work happens (`date +%H:%M:%S`).

---

## Documentation contract

All six, plus **`docs/internal/chunks/C5-COMPLETED.md`** at C1–C4 depth (570/605/654/600 lines), with
