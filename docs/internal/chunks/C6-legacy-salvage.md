...
Produce **`docs/legacy-command-vocabulary.md`**: every distinct command id found, what it
...
- [ ] `docs/legacy-command-vocabulary.md` complete, mechanically cross-checked, with each
...
`docs/internal/chunks/C6-PROGRESS.md`, appended as work happens (`date +%H:%M:%S`).

---

## Documentation contract

All six, plus **`docs/internal/chunks/C6-COMPLETED.md`**. Depth here is measured by the **completeness
