...
`docs/internal/chunks/C4-PROGRESS.md`, appended as work happens (`date +%H:%M:%S`).

---

## Documentation contract

All six, plus **`docs/internal/chunks/C4-COMPLETED.md`** at C1–C3 depth (570/605/654 lines), with a
